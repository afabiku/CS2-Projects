...
//  it writing outside of the array, str is a size of 5, going over it writes over meta data
//   Why is no error raised?
// c++ is a lose bound language, it doesnt check array bounds
//   How many bytes are between the start of str1 and str2?
//   &str2 - &str1 = bytes
//   How could you test for this logical error? using valgrind
//   How could you prevent this type of error? by checking that you not going outside of bound
//
//   Include the delete[] at then end and recompile, what changes? theres no more meory leak
